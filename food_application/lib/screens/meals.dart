...
import 'package:food_application/screens/meal_details.dart';
import 'package:food_application/widgets/meal_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if(meals.isEmpty){
      content = Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        Text('Uh uh... nothing here!',style: Theme.of(context).textTheme.headlineLarge!.copyWith(color: Theme.of(context).colorScheme.onBackground)),
    ...
    if(meals.isNotEmpty){
      content = ListView.builder(
        itemCount: meals.length, itemBuilder: (ctx, index) =>
