...
import 'package:food_application/widgets/category_grid_item.dart';
import 'package:food_application/models/category.dart';
...
class CategoriesScreen extends StatelessWidget{
  ...
  void _selectCategory(BuildContext context, Category category){
    ...
    Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => MealsScreen(title: category.title , meals: filteredMeals, onToggleFavorite: onToggleFavorite)));
  }
