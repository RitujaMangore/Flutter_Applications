...
class _NewExpenseState extends State<NewExpense>{
  ...
  void _submitExpenseData(){
    ...
    final amountIsInvalid = _enterAmount == null || _enterAmount <= 0;
     ...
     widget.onAddExpense(Expense(title: _titleController.text, amount: _enterAmount, date: _selectedDate!, category: _selectedCategory));
